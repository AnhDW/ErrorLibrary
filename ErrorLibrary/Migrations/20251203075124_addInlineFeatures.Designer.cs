...
namespace ErrorLibrary.Migrations
{
    ...
    [Migration("20251203075124_addInlineFeatures")]
    partial class addInlineFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErrorLibrary.Entities.InLineDetail", b =>
                {
                    ...
                    b.Property<int>("TimeFrameColorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ErrorLibrary.Entities.InLineDetail", b =>
                {
                    ...
                    b.HasOne("ErrorLibrary.Entities.TimeFrameColor", "TimeFrameColor")
                        .WithMany("CheckInLineDetails")
                        .HasForeignKey("TimeFrameColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ErrorLibrary.Entities.Error", b =>
                {
                    b.Navigation("CheckInLineDetails");
